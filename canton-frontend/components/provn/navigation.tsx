...
const CampModal = ({ children }: { children: React.ReactNode }) => <>{children}</>;
const useAuth = () => ({ isAuthenticated: false, user: null, login: () => {}, logout: () => {}, walletAddress: null as string | null });

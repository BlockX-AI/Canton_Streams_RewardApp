...
const contractAddresses = [
  { name: "StreamCore", address: "canton::stream::core", network: "Canton DevNet" },
  { name: "TokenVault", address: "canton::vault::core", network: "Canton DevNet" },
  { name: "SplitsRouter", address: "canton::splits::router", network: "Canton DevNet" },
  { name: "PermissionManager", address: "canton::perm::mgr", network: "Canton DevNet" },
  { name: "BountyAdapter", address: "canton::bounty::adapter", network: "Canton DevNet" },
]
...
const faqs = [
  {
    ...
    a: "Currently CC and USDCx on Canton DevNet. More tokens will be added progressively. The protocol is token-agnostic — any CIP-56 compatible token can be streamed.",
  },
  {
  ...
  },
  {
    ...
    a: "No hard minimum, and Canton DevNet has no gas fees. Practically, any amount above $0.01/hour is viable.",
  },
  {
      ...
      <section id="contracts" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-provn-muted">
              Deployed on Canton DevNet. Mainnet addresses coming soon.
            </p>
          </motion.div>

...
const ecosystemPartners = [
  { name: "Canton Network", category: "Infrastructure", status: "Live" },
  { name: "Digital Asset (DAML)", category: "Infrastructure", status: "Live" },
  { name: "Ledger API", category: "Ecosystem", status: "Integrated" },
  { name: "CC Token", category: "Token", status: "Supported" },
]

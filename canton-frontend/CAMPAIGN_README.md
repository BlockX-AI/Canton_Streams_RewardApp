...
The Web3 Contribution Challenge is a developer engagement campaign that analyzes GitHub contributions, scores them with AI, and mints achievement NFTs on Canton Network.
...
| `useReclaimContract` | On-chain proof validation (optional) |
...
| Item | Details |
|------|---------|
| **Network** | Canton DevNet (`http://localhost:7575`) |
| **Wallet support** | Canton Party ID |
| **NFT standard** | DAML templates (via backend API) |
| **Gas cost** | No gas on DevNet |
...
CANTON_PACKAGE_ID=<your-package-id>
...
| Item | Cost |
|------|------|
| NFT mint | Minimal (Canton fees) |
| Contract deploy | One-time setup cost |
